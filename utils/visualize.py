...
def visualizer_function(point_cloud_file_path, point_file_path):
    # Load points
    point_cloud_data, point_data = helpers.load_data(point_cloud_file_path, point_file_path)
    ...
    matching_points = helpers.check_matching_points(point_cloud_data, point_data)

    # Assign color for matching points (black)

    matching_colors = helpers.assign_color(matching_points, [0, 0, 0])
